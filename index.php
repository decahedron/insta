...
<html lang="en">
  ...
  <body>
			...
			<?php 
			 ...
			 ?>			
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12" style="height: 400px; background-image: url(<?php echo $res['img'] ?>); background-size: 100% 100%"> <!--картинка поста-->
					</div>
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div>
							<button class='btn btn-light text-primary edit'>редактировать</button>
							<div class='col-12 bg-danger editform'>
								<form action='update.php' method='GET'>
									<p><input type="text" name="img" class="form-control" placeholder="image url" value="<?php echo $res['img'] ?>"></p>
									...
									<button class='btn btn-light text-primary'>сохранить</button>
								</form>
							</div>
						</div>					
					</div>
    ...
    <script type="text/javascript">
    	...
    	let form = document.querySelectorAll('editform');

    	for (i=0;i< <?php $query->num_rows ?>; i++){
